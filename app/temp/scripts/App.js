...
/***/ function(module, exports, __webpack_require__) {
	...
	var _menuReveal = __webpack_require__(1);
	...
	var _animateHome = __webpack_require__(4);

	var _animateHome2 = _interopRequireDefault(_animateHome);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuReveal = function () {
	    function MenuReveal() {
	        _classCallCheck(this, MenuReveal);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormValidation = function () {
	    function FormValidation() {
	        ...
	        this.nameInput = (0, _jquery2.default)("form #Name");
	        this.emailInput = (0, _jquery2.default)("form #Email");
	        this.messageInput = (0, _jquery2.default)("form #Message");
	        this.submitButton = (0, _jquery2.default)("form #submit");
	        this.successMessage = (0, _jquery2.default)("form .form__messages--success");
	        this.errorMessage = (0, _jquery2.default)("form .form__messages--error");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnimateHome = function () {
	    function AnimateHome() {
	        _classCallCheck(this, AnimateHome);

	        this.logo = (0, _jquery2.default)(".fa-logo");
	        this.menuIcon = (0, _jquery2.default)(".header-section__menu-icon");
	        this.document = (0, _jquery2.default)(document);
	        this.events();
	    }

	    _createClass(AnimateHome, [{
	        key: "events",
	        value: function events() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RevealOnScroll = function () {
	    function RevealOnScroll(item, anim, offset) {
	            ...
	            this.revealItems.each(function () {
	                ...
	                new Waypoint({
	                    ...
	                    handler: function handler() {
	                        (0, _jquery2.default)(currentItem).addClass(that.animation);
